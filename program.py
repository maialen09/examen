...
dicx = {'E': 1, 'A': 2,'O':3 ,'L': 4, 'S':5 , 'N': 6, 'D':7 , 'R': 8, 'U':9 , 'I':10 , 'T': 11, 'C':12 , 'P': 13, 'M': 14, 'Y':15  , 'Q': 16, 'B':17 , 'H':18 , 'G':19 , 'F': 20, 'V':21 , 'J':22 , 'Ñ': 23, 'Z': 24, 'X': 25, 'K': 26, 'W':27 }
